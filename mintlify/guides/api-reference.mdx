...
<CardGroup cols={2}>
  ...
  <Card title="Email orders" icon="envelope" href="/api-reference/email-orders/create-order">
    Order rewards delivered by Giftbit email.
  </Card>
  <Card title="Shortlink orders" icon="link" href="/api-reference/email-orders/create-order">
