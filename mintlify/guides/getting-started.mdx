...
<CardGroup cols={3}>
  <Card title="Link-based" icon="link">
    Receive a unique link and pass it to another system to deliver by email, SMS, or another method.
  </Card>
  <Card title="Email" icon="envelope">
    Giftbit delivers a customized reward email to each recipient.
  </Card>
  <Card title="In-app" icon="mobile-screen">
...
<AccordionGroup>
  ...
  <Accordion title="Shortlinks include a customized landing page">
    ...
    Use the [`/campaign`](/api-reference/shortlink-orders/create-shortlink-order) endpoint along with the `delivery_type: SHORTLINK` property to request shortlink rewards.
  </Accordion>
</AccordionGroup>
